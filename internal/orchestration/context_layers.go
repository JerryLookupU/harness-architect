...
func BuildVerifySkeleton(taskID, dispatchID string, family TaskFamily, sopID, executionSliceID, executionCWD, worktreePath, contextLayersPath, requestContextPath, runtimeContextPath, sharedFlowContextPath, sliceContextPath, taskContractPath, taskGraphPath, handoffContractPath, closeoutSkeletonPath string, phaseArtifacts []PhaseArtifactRef, programOwns, artifacts []string, checks []VerifyCheck, notes []string) VerifySkeleton {
...
func BuildHandoffContract(taskID, dispatchID string, family TaskFamily, sopID, executionSliceID, contextLayersPath, requestContextPath, runtimeContextPath, sharedFlowContextPath, sliceContextPath, taskContractPath, taskGraphPath, verifySkeletonPath, closeoutSkeletonPath, handoffPath, takeoverPath string, requiredArtifacts []string, sections []HandoffSection, resumeInstructions []string) HandoffContract {
...
func BuildCloseoutSkeleton(taskID, dispatchID string, family TaskFamily, sopID, executionSliceID, contextLayersPath, requestContextPath, runtimeContextPath, sharedFlowContextPath, sliceContextPath, taskContractPath, taskGraphPath, verifySkeletonPath, handoffContractPath, handoffPath, takeoverPath string, phaseArtifacts []PhaseArtifactRef, requiredArtifacts []string, sections []CloseoutSection, workerMustProvide, programWillFinalize, resumeChecklist []string) CloseoutSkeleton {
